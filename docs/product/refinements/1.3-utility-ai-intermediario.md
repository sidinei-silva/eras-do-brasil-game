...
- JSON de cada NPC ganha campo weights (com 5 floats: hunger, energy, social, security, schedule). Loader popula o struct Npc.Weights. Sem defaults — JSON deve declarar todos os 5, falha no startup se faltar algum.:
