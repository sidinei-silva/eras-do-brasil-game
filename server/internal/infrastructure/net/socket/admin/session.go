...
type AdminSession struct {
	...
	send   chan []byte
	id     string
	router *net.AdminRouter // O Roteador de Comandos do Admin
}

func NewAdminSession(hub *Hub, conn *websocket.Conn, router *net.AdminRouter, ctx context.Context) *AdminSession {
	return &AdminSession{
		hub:    hub,
		conn:   conn,
